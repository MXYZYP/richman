import board from '../maps/shanxi-tour/v1/board.json';
import cards from '../maps/shanxi-tour/v1/cards.json';
import config from '../maps/shanxi-tour/v1/game-config.json';
import manifest from '../maps/shanxi-tour/v1/manifest.json';
...
/** 「山西之旅」：蛇形网格：48 格 6×8 逐层铺开，自雁门关一路南下到蒲津渡，晋南地价最高，走到太行脚下再折回起点。 */
export const shanxiTourMap: Readonly<MapPack> = deepFreeze(mapPack);
