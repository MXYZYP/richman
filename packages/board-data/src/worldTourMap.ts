import board from '../maps/world-tour/v1/board.json';
import cards from '../maps/world-tour/v1/cards.json';
import config from '../maps/world-tour/v1/game-config.json';
import manifest from '../maps/world-tour/v1/manifest.json';
...
export const worldTourMap: Readonly<MapPack> = deepFreeze(mapPack);
