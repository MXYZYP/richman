import board from '../maps/classic-tour/v1/board.json';
import cards from '../maps/classic-tour/v1/cards.json';
import config from '../maps/classic-tour/v1/game-config.json';
import manifest from '../maps/classic-tour/v1/manifest.json';
...
export const classicTourMap: Readonly<MapPack> = deepFreeze(mapPack);
